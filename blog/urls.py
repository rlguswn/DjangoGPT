...
urlpatterns = [
    # 글 목록 조회
    path("", views.PostIndex.as_view(), name='list'),  # /blog/
    # # 글 상세 조회
    path("detail/<int:pk>/", views.PostDetail.as_view(), name='detail'),  # /blog/detail/1/
    # # 글 작성
    path("write/", views.PostWrite.as_view(), name='write'),  # /blog/write/
    # # 글 수정
